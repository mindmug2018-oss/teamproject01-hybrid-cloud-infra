...
# mgmt — public subnet, Rocky Linux
# Runs: HAProxy (load balancer), Ansible control node, Prometheus, Grafana, AlertManager
...
# rocky1 — private subnet, Rocky Linux
...
# rocky2 — private subnet, Rocky Linux (identical to rocky1 for HA)
